...
//list courses:
var $courses = $('#courses'),
	 suggestions = String($courses.attr('data-suggestions')).split(',');

$courses.textext({
	plugins : 'autocomplete suggestions tags prompt arrow',
	suggestions : suggestions,
	prompt: 'Type here to select courses taught'
});

//edit a course:
var $e_courses = $('#e_courses'),
suggestions = String($e_courses.attr('data-suggestions')).split(',');
var values = String($e_courses.attr('value')).split(',');
$e_courses.attr('value', '');
...
var $examdate = $('#examdate'),
	 suggestions = String($examdate.attr('data-suggestions')).split(',');

$examdate.textext({
	plugins : 'autocomplete suggestions tags prompt arrow',
	suggestions : suggestions,
	prompt: 'Type here to select your available dates for exam'
});

//edit exam dates:
var $e_examdate = $('#e_examdate'),
suggestions = String($e_examdate.attr('data-suggestions')).split(',');
var values = String($e_examdate.attr('value')).split(',');
$e_examdate.attr('value', '');
